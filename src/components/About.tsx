        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <a
              ...
              download
              className="mt-8 inline-flex items-center gap-2 px-6 py-2.5 border border-indigo-600 hover:border-indigo-400 text-indigo-400 hover:text-indigo-300 font-semibold rounded-lg transition-colors duration-200 text-sm"
            >
            ...
            <div className="bg-[#1a1838] border border-[#332f6e] rounded-xl p-5">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <a
                  ...
                  className="flex-1 flex items-center justify-center gap-2 py-2.5 bg-[#0f0e28] hover:bg-[#252354] border border-[#332f6e] hover:border-[#453f9e] text-gray-300 hover:text-white text-sm font-medium rounded-lg transition-all duration-200"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex-1 flex items-center justify-center gap-2 py-2.5 bg-indigo-900/30 hover:bg-indigo-900/50 border border-indigo-800 hover:border-indigo-600 text-indigo-400 hover:text-indigo-300 text-sm font-medium rounded-lg transition-all duration-200"
                >
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
